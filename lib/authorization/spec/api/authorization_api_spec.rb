...
# Unit tests for AmzSpApi::Authorization::AuthorizationApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AuthorizationApi' do
  before do
    # run before each test
    @instance = AmzSpApi::Authorization::AuthorizationApi.new
  end
  ...
  describe 'test an instance of AuthorizationApi' do
    it 'should create an instance of AuthorizationApi' do
      expect(@instance).to be_instance_of(AmzSpApi::Authorization::AuthorizationApi)
    end
  end
