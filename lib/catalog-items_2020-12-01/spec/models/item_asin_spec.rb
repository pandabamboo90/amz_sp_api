...
# Unit tests for AmzSpApi::CatalogItems_20201201::ItemAsin
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemAsin' do
  before do
    # run before each test
    @instance = AmzSpApi::CatalogItems_20201201::ItemAsin.new
  end
  ...
  describe 'test an instance of ItemAsin' do
    it 'should create an instance of ItemAsin' do
      expect(@instance).to be_instance_of(AmzSpApi::CatalogItems_20201201::ItemAsin)
    end
  end
end
