...
# Unit tests for AmzSpApi::CatalogItems_20201201::ItemAttributes
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemAttributes' do
  before do
    # run before each test
    @instance = AmzSpApi::CatalogItems_20201201::ItemAttributes.new
  end
  ...
  describe 'test an instance of ItemAttributes' do
    it 'should create an instance of ItemAttributes' do
      expect(@instance).to be_instance_of(AmzSpApi::CatalogItems_20201201::ItemAttributes)
    end
  end
end
