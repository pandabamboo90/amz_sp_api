...
# Unit tests for AmzSpApi::CatalogItems_20201201::ItemIdentifiersByMarketplace
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemIdentifiersByMarketplace' do
  before do
    # run before each test
    @instance = AmzSpApi::CatalogItems_20201201::ItemIdentifiersByMarketplace.new
  end
  ...
  describe 'test an instance of ItemIdentifiersByMarketplace' do
    it 'should create an instance of ItemIdentifiersByMarketplace' do
      expect(@instance).to be_instance_of(AmzSpApi::CatalogItems_20201201::ItemIdentifiersByMarketplace)
    end
  end
