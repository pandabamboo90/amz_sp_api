...
# Unit tests for AmzSpApi::CatalogItems_20201201::ItemImagesByMarketplace
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemImagesByMarketplace' do
  before do
    # run before each test
    @instance = AmzSpApi::CatalogItems_20201201::ItemImagesByMarketplace.new
  end
  ...
  describe 'test an instance of ItemImagesByMarketplace' do
    it 'should create an instance of ItemImagesByMarketplace' do
      expect(@instance).to be_instance_of(AmzSpApi::CatalogItems_20201201::ItemImagesByMarketplace)
    end
  end
