...
# Unit tests for AmzSpApi::CatalogItems_20201201::ItemImages
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemImages' do
  before do
    # run before each test
    @instance = AmzSpApi::CatalogItems_20201201::ItemImages.new
  end
  ...
  describe 'test an instance of ItemImages' do
    it 'should create an instance of ItemImages' do
      expect(@instance).to be_instance_of(AmzSpApi::CatalogItems_20201201::ItemImages)
    end
  end
end
