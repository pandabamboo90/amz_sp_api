...
# Unit tests for AmzSpApi::CatalogItems_20201201::ItemSalesRank
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemSalesRank' do
  before do
    # run before each test
    @instance = AmzSpApi::CatalogItems_20201201::ItemSalesRank.new
  end
  ...
  describe 'test an instance of ItemSalesRank' do
    it 'should create an instance of ItemSalesRank' do
      expect(@instance).to be_instance_of(AmzSpApi::CatalogItems_20201201::ItemSalesRank)
    end
  end
