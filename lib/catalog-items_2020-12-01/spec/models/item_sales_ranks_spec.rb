...
# Unit tests for AmzSpApi::CatalogItems_20201201::ItemSalesRanks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemSalesRanks' do
  before do
    # run before each test
    @instance = AmzSpApi::CatalogItems_20201201::ItemSalesRanks.new
  end
  ...
  describe 'test an instance of ItemSalesRanks' do
    it 'should create an instance of ItemSalesRanks' do
      expect(@instance).to be_instance_of(AmzSpApi::CatalogItems_20201201::ItemSalesRanks)
    end
  end
end
