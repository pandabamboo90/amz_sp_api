...
# Unit tests for AmzSpApi::CatalogItems_20201201::Refinements
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Refinements' do
  before do
    # run before each test
    @instance = AmzSpApi::CatalogItems_20201201::Refinements.new
  end
  ...
  describe 'test an instance of Refinements' do
    it 'should create an instance of Refinements' do
      expect(@instance).to be_instance_of(AmzSpApi::CatalogItems_20201201::Refinements)
    end
  end
