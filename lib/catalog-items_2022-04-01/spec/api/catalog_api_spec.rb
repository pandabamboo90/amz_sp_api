...
# Unit tests for AmzSpApi::CatalogItems_20220401::CatalogApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CatalogApi' do
  before do
    # run before each test
    @instance = AmzSpApi::CatalogItems_20220401::CatalogApi.new
  end
  ...
  describe 'test an instance of CatalogApi' do
    it 'should create an instance of CatalogApi' do
      expect(@instance).to be_instance_of(AmzSpApi::CatalogItems_20220401::CatalogApi)
    end
  end
