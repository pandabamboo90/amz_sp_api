...
# Unit tests for AmzSpApi::DefinitionsProductTypes_20200901::DefinitionsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DefinitionsApi' do
  before do
    # run before each test
    @instance = AmzSpApi::DefinitionsProductTypes_20200901::DefinitionsApi.new
  end
  ...
  describe 'test an instance of DefinitionsApi' do
    it 'should create an instance of DefinitionsApi' do
      expect(@instance).to be_instance_of(AmzSpApi::DefinitionsProductTypes_20200901::DefinitionsApi)
    end
  end
