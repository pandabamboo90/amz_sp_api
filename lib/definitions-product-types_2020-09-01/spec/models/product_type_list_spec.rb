...
# Unit tests for AmzSpApi::DefinitionsProductTypes_20200901::ProductTypeList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProductTypeList' do
  before do
    # run before each test
    @instance = AmzSpApi::DefinitionsProductTypes_20200901::ProductTypeList.new
  end
  ...
  describe 'test an instance of ProductTypeList' do
    it 'should create an instance of ProductTypeList' do
      expect(@instance).to be_instance_of(AmzSpApi::DefinitionsProductTypes_20200901::ProductTypeList)
    end
  end
