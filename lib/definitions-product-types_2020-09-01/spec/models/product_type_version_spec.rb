...
# Unit tests for AmzSpApi::DefinitionsProductTypes_20200901::ProductTypeVersion
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProductTypeVersion' do
  before do
    # run before each test
    @instance = AmzSpApi::DefinitionsProductTypes_20200901::ProductTypeVersion.new
  end
  ...
  describe 'test an instance of ProductTypeVersion' do
    it 'should create an instance of ProductTypeVersion' do
      expect(@instance).to be_instance_of(AmzSpApi::DefinitionsProductTypes_20200901::ProductTypeVersion)
    end
  end
