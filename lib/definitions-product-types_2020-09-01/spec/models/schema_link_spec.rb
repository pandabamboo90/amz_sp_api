...
# Unit tests for AmzSpApi::DefinitionsProductTypes_20200901::SchemaLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SchemaLink' do
  before do
    # run before each test
    @instance = AmzSpApi::DefinitionsProductTypes_20200901::SchemaLink.new
  end
  ...
  describe 'test an instance of SchemaLink' do
    it 'should create an instance of SchemaLink' do
      expect(@instance).to be_instance_of(AmzSpApi::DefinitionsProductTypes_20200901::SchemaLink)
    end
  end
