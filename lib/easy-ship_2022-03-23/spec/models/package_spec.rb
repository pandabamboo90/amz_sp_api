...
# Unit tests for AmzSpApi::EasyShip_20220323::Package
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Package' do
  before do
    # run before each test
    @instance = AmzSpApi::EasyShip_20220323::Package.new
  end
  ...
  describe 'test an instance of Package' do
    it 'should create an instance of Package' do
      expect(@instance).to be_instance_of(AmzSpApi::EasyShip_20220323::Package)
    end
  end
