...
# Unit tests for AmzSpApi::FbaInbound::ItemEligibilityPreview
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemEligibilityPreview' do
  before do
    # run before each test
    @instance = AmzSpApi::FbaInbound::ItemEligibilityPreview.new
  end
  ...
  describe 'test an instance of ItemEligibilityPreview' do
    it 'should create an instance of ItemEligibilityPreview' do
      expect(@instance).to be_instance_of(AmzSpApi::FbaInbound::ItemEligibilityPreview)
    end
  end
