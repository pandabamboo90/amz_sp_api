...
# Unit tests for AmzSpApi::FbaSmallandLight::SmallAndLightApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SmallAndLightApi' do
  before do
    # run before each test
    @instance = AmzSpApi::FbaSmallandLight::SmallAndLightApi.new
  end
  ...
  describe 'test an instance of SmallAndLightApi' do
    it 'should create an instance of SmallAndLightApi' do
      expect(@instance).to be_instance_of(AmzSpApi::FbaSmallandLight::SmallAndLightApi)
    end
  end
