...
# Unit tests for AmzSpApi::Feeds_20200904::CreateFeedSpecification
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateFeedSpecification' do
  before do
    # run before each test
    @instance = AmzSpApi::Feeds_20200904::CreateFeedSpecification.new
  end
  ...
  describe 'test an instance of CreateFeedSpecification' do
    it 'should create an instance of CreateFeedSpecification' do
      expect(@instance).to be_instance_of(AmzSpApi::Feeds_20200904::CreateFeedSpecification)
    end
  end
