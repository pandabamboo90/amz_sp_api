...
# Unit tests for AmzSpApi::Feeds_20200904::FeedDocument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeedDocument' do
  before do
    # run before each test
    @instance = AmzSpApi::Feeds_20200904::FeedDocument.new
  end
  ...
  describe 'test an instance of FeedDocument' do
    it 'should create an instance of FeedDocument' do
      expect(@instance).to be_instance_of(AmzSpApi::Feeds_20200904::FeedDocument)
    end
  end
