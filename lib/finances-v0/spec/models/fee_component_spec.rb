...
# Unit tests for AmzSpApi::FinancesV0::FeeComponent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeeComponent' do
  before do
    # run before each test
    @instance = AmzSpApi::FinancesV0::FeeComponent.new
  end
  ...
  describe 'test an instance of FeeComponent' do
    it 'should create an instance of FeeComponent' do
      expect(@instance).to be_instance_of(AmzSpApi::FinancesV0::FeeComponent)
    end
  end
