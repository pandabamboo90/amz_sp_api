...
# Unit tests for AmzSpApi::FinancesV0::SAFETReimbursementEvent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SAFETReimbursementEvent' do
  before do
    # run before each test
    @instance = AmzSpApi::FinancesV0::SAFETReimbursementEvent.new
  end
  ...
  describe 'test an instance of SAFETReimbursementEvent' do
    it 'should create an instance of SAFETReimbursementEvent' do
      expect(@instance).to be_instance_of(AmzSpApi::FinancesV0::SAFETReimbursementEvent)
    end
  end
