...
# Unit tests for AmzSpApi::FulfillmentInboundV0::ASINPrepInstructions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ASINPrepInstructions' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentInboundV0::ASINPrepInstructions.new
  end
  ...
  describe 'test an instance of ASINPrepInstructions' do
    it 'should create an instance of ASINPrepInstructions' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentInboundV0::ASINPrepInstructions)
    end
  end
