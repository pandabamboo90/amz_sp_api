...
# Unit tests for AmzSpApi::FulfillmentInboundV0::NonPartneredLtlDataInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NonPartneredLtlDataInput' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentInboundV0::NonPartneredLtlDataInput.new
  end
  ...
  describe 'test an instance of NonPartneredLtlDataInput' do
    it 'should create an instance of NonPartneredLtlDataInput' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentInboundV0::NonPartneredLtlDataInput)
    end
  end
