...
# Unit tests for AmzSpApi::FulfillmentInboundV0::NonPartneredSmallParcelDataInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NonPartneredSmallParcelDataInput' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentInboundV0::NonPartneredSmallParcelDataInput.new
  end
  ...
  describe 'test an instance of NonPartneredSmallParcelDataInput' do
    it 'should create an instance of NonPartneredSmallParcelDataInput' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentInboundV0::NonPartneredSmallParcelDataInput)
    end
  end
