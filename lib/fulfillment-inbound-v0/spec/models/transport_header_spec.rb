...
# Unit tests for AmzSpApi::FulfillmentInboundV0::TransportHeader
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransportHeader' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentInboundV0::TransportHeader.new
  end
  ...
  describe 'test an instance of TransportHeader' do
    it 'should create an instance of TransportHeader' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentInboundV0::TransportHeader)
    end
  end
