...
# Unit tests for AmzSpApi::FulfillmentOutbound_20200701::CreateFulfillmentReturnResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateFulfillmentReturnResult' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentOutbound_20200701::CreateFulfillmentReturnResult.new
  end
  ...
  describe 'test an instance of CreateFulfillmentReturnResult' do
    it 'should create an instance of CreateFulfillmentReturnResult' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentOutbound_20200701::CreateFulfillmentReturnResult)
    end
  end
