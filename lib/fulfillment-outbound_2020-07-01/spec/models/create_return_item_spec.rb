...
# Unit tests for AmzSpApi::FulfillmentOutbound_20200701::CreateReturnItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateReturnItem' do
  before do
    # run before each test
    @instance = AmzSpApi::FulfillmentOutbound_20200701::CreateReturnItem.new
  end
  ...
  describe 'test an instance of CreateReturnItem' do
    it 'should create an instance of CreateReturnItem' do
      expect(@instance).to be_instance_of(AmzSpApi::FulfillmentOutbound_20200701::CreateReturnItem)
    end
  end
