...
# Unit tests for AmzSpApi::ListingsItems_20210801::ItemProcurement
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemProcurement' do
  before do
    # run before each test
    @instance = AmzSpApi::ListingsItems_20210801::ItemProcurement.new
  end
  ...
  describe 'test an instance of ItemProcurement' do
    it 'should create an instance of ItemProcurement' do
      expect(@instance).to be_instance_of(AmzSpApi::ListingsItems_20210801::ItemProcurement)
    end
  end
