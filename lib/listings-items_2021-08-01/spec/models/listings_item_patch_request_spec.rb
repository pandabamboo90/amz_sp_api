...
# Unit tests for AmzSpApi::ListingsItems_20210801::ListingsItemPatchRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListingsItemPatchRequest' do
  before do
    # run before each test
    @instance = AmzSpApi::ListingsItems_20210801::ListingsItemPatchRequest.new
  end
  ...
  describe 'test an instance of ListingsItemPatchRequest' do
    it 'should create an instance of ListingsItemPatchRequest' do
      expect(@instance).to be_instance_of(AmzSpApi::ListingsItems_20210801::ListingsItemPatchRequest)
    end
  end
