...
# Unit tests for AmzSpApi::MerchantFulfillmentV0::AvailableDeliveryExperienceOption
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AvailableDeliveryExperienceOption' do
  before do
    # run before each test
    @instance = AmzSpApi::MerchantFulfillmentV0::AvailableDeliveryExperienceOption.new
  end
  ...
  describe 'test an instance of AvailableDeliveryExperienceOption' do
    it 'should create an instance of AvailableDeliveryExperienceOption' do
      expect(@instance).to be_instance_of(AmzSpApi::MerchantFulfillmentV0::AvailableDeliveryExperienceOption)
    end
  end
