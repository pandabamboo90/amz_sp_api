...
# Unit tests for AmzSpApi::MerchantFulfillmentV0::GetEligibleShipmentServicesResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetEligibleShipmentServicesResult' do
  before do
    # run before each test
    @instance = AmzSpApi::MerchantFulfillmentV0::GetEligibleShipmentServicesResult.new
  end
  ...
  describe 'test an instance of GetEligibleShipmentServicesResult' do
    it 'should create an instance of GetEligibleShipmentServicesResult' do
      expect(@instance).to be_instance_of(AmzSpApi::MerchantFulfillmentV0::GetEligibleShipmentServicesResult)
    end
  end
