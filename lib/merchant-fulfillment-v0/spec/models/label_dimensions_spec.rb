...
# Unit tests for AmzSpApi::MerchantFulfillmentV0::LabelDimensions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LabelDimensions' do
  before do
    # run before each test
    @instance = AmzSpApi::MerchantFulfillmentV0::LabelDimensions.new
  end
  ...
  describe 'test an instance of LabelDimensions' do
    it 'should create an instance of LabelDimensions' do
      expect(@instance).to be_instance_of(AmzSpApi::MerchantFulfillmentV0::LabelDimensions)
    end
  end
