...
# Unit tests for AmzSpApi::Notifications::DeleteSubscriptionByIdResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeleteSubscriptionByIdResponse' do
  before do
    # run before each test
    @instance = AmzSpApi::Notifications::DeleteSubscriptionByIdResponse.new
  end
  ...
  describe 'test an instance of DeleteSubscriptionByIdResponse' do
    it 'should create an instance of DeleteSubscriptionByIdResponse' do
      expect(@instance).to be_instance_of(AmzSpApi::Notifications::DeleteSubscriptionByIdResponse)
    end
  end
