...
# Unit tests for AmzSpApi::Notifications::DestinationResourceSpecification
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DestinationResourceSpecification' do
  before do
    # run before each test
    @instance = AmzSpApi::Notifications::DestinationResourceSpecification.new
  end
  ...
  describe 'test an instance of DestinationResourceSpecification' do
    it 'should create an instance of DestinationResourceSpecification' do
      expect(@instance).to be_instance_of(AmzSpApi::Notifications::DestinationResourceSpecification)
    end
  end
