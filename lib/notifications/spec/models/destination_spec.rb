...
# Unit tests for AmzSpApi::Notifications::Destination
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Destination' do
  before do
    # run before each test
    @instance = AmzSpApi::Notifications::Destination.new
  end
  ...
  describe 'test an instance of Destination' do
    it 'should create an instance of Destination' do
      expect(@instance).to be_instance_of(AmzSpApi::Notifications::Destination)
    end
  end
