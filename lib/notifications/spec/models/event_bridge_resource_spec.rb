...
# Unit tests for AmzSpApi::Notifications::EventBridgeResource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EventBridgeResource' do
  before do
    # run before each test
    @instance = AmzSpApi::Notifications::EventBridgeResource.new
  end
  ...
  describe 'test an instance of EventBridgeResource' do
    it 'should create an instance of EventBridgeResource' do
      expect(@instance).to be_instance_of(AmzSpApi::Notifications::EventBridgeResource)
    end
  end
