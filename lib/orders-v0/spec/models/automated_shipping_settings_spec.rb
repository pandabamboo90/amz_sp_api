...
# Unit tests for AmzSpApi::OrdersV0::AutomatedShippingSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AutomatedShippingSettings' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersV0::AutomatedShippingSettings.new
  end
  ...
  describe 'test an instance of AutomatedShippingSettings' do
    it 'should create an instance of AutomatedShippingSettings' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersV0::AutomatedShippingSettings)
    end
  end
