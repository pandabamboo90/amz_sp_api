...
# Unit tests for AmzSpApi::OrdersV0::OrderRegulatedInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderRegulatedInfo' do
  before do
    # run before each test
    @instance = AmzSpApi::OrdersV0::OrderRegulatedInfo.new
  end
  ...
  describe 'test an instance of OrderRegulatedInfo' do
    it 'should create an instance of OrderRegulatedInfo' do
      expect(@instance).to be_instance_of(AmzSpApi::OrdersV0::OrderRegulatedInfo)
    end
  end
