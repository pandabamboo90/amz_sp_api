...
# Unit tests for AmzSpApi::ProductFeesV0::IncludedFeeDetail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IncludedFeeDetail' do
  before do
    # run before each test
    @instance = AmzSpApi::ProductFeesV0::IncludedFeeDetail.new
  end
  ...
  describe 'test an instance of IncludedFeeDetail' do
    it 'should create an instance of IncludedFeeDetail' do
      expect(@instance).to be_instance_of(AmzSpApi::ProductFeesV0::IncludedFeeDetail)
    end
  end
