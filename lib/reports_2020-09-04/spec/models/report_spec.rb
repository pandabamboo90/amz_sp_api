...
# Unit tests for AmzSpApi::Reports_20200904::Report
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Report' do
  before do
    # run before each test
    @instance = AmzSpApi::Reports_20200904::Report.new
  end
  ...
  describe 'test an instance of Report' do
    it 'should create an instance of Report' do
      expect(@instance).to be_instance_of(AmzSpApi::Reports_20200904::Report)
    end
  end
