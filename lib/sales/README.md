...
AmzSpApi::Sales - the Ruby gem for the Selling Partner API for Sales
...
```shell
gem build sales.gemspec
```

Then either install the gem locally:

```shell
gem install ./sales-0.1.0.gem
```
(for development, run `gem install --dev ./sales-0.1.0.gem` to install the development dependencies)
...
If the Ruby gem is hosted at a git repository: https://github.com/GIT_USER_ID/GIT_REPO_ID, then add the following in the Gemfile:
    ...
    gem 'sales', :git => 'https://github.com/GIT_USER_ID/GIT_REPO_ID.git'
...
------------ | ------------- | ------------- | -------------
*AmzSpApi::Sales::SalesApi* | [**get_order_metrics**](docs/SalesApi.md#get_order_metrics) | **GET** /sales/v1/orderMetrics | 

## Documentation for Models

 - [AmzSpApi::Sales::Decimal](docs/Decimal.md)
 - [AmzSpApi::Sales::Error](docs/Error.md)
 - [AmzSpApi::Sales::ErrorList](docs/ErrorList.md)
 - [AmzSpApi::Sales::GetOrderMetricsResponse](docs/GetOrderMetricsResponse.md)
 - [AmzSpApi::Sales::Money](docs/Money.md)
 - [AmzSpApi::Sales::OrderMetricsInterval](docs/OrderMetricsInterval.md)
 - [AmzSpApi::Sales::OrderMetricsList](docs/OrderMetricsList.md)
