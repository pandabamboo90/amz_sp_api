...
# Unit tests for AmzSpApi::Services::CreateReservationRecord
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateReservationRecord' do
  before do
    # run before each test
    @instance = AmzSpApi::Services::CreateReservationRecord.new
  end
  ...
  describe 'test an instance of CreateReservationRecord' do
    it 'should create an instance of CreateReservationRecord' do
      expect(@instance).to be_instance_of(AmzSpApi::Services::CreateReservationRecord)
    end
  end
