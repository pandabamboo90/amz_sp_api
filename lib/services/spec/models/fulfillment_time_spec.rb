...
# Unit tests for AmzSpApi::Services::FulfillmentTime
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FulfillmentTime' do
  before do
    # run before each test
    @instance = AmzSpApi::Services::FulfillmentTime.new
  end
  ...
  describe 'test an instance of FulfillmentTime' do
    it 'should create an instance of FulfillmentTime' do
      expect(@instance).to be_instance_of(AmzSpApi::Services::FulfillmentTime)
    end
  end
