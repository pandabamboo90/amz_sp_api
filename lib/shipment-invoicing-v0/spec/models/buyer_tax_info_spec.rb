...
# Unit tests for AmzSpApi::ShipmentInvoicingV0::BuyerTaxInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BuyerTaxInfo' do
  before do
    # run before each test
    @instance = AmzSpApi::ShipmentInvoicingV0::BuyerTaxInfo.new
  end
  ...
  describe 'test an instance of BuyerTaxInfo' do
    it 'should create an instance of BuyerTaxInfo' do
      expect(@instance).to be_instance_of(AmzSpApi::ShipmentInvoicingV0::BuyerTaxInfo)
    end
  end
