...
# Unit tests for AmzSpApi::ShipmentInvoicingV0::ShipmentDetail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShipmentDetail' do
  before do
    # run before each test
    @instance = AmzSpApi::ShipmentInvoicingV0::ShipmentDetail.new
  end
  ...
  describe 'test an instance of ShipmentDetail' do
    it 'should create an instance of ShipmentDetail' do
      expect(@instance).to be_instance_of(AmzSpApi::ShipmentInvoicingV0::ShipmentDetail)
    end
  end
