...
# Unit tests for AmzSpApi::Shipping::ContainerSpecification
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ContainerSpecification' do
  before do
    # run before each test
    @instance = AmzSpApi::Shipping::ContainerSpecification.new
  end
  ...
  describe 'test an instance of ContainerSpecification' do
    it 'should create an instance of ContainerSpecification' do
      expect(@instance).to be_instance_of(AmzSpApi::Shipping::ContainerSpecification)
    end
  end
