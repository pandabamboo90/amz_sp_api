...
# Unit tests for AmzSpApi::Solicitations::SolicitationsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SolicitationsApi' do
  before do
    # run before each test
    @instance = AmzSpApi::Solicitations::SolicitationsApi.new
  end
  ...
  describe 'test an instance of SolicitationsApi' do
    it 'should create an instance of SolicitationsApi' do
      expect(@instance).to be_instance_of(AmzSpApi::Solicitations::SolicitationsApi)
    end
  end
