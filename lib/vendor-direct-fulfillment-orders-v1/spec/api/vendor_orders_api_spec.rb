...
# Unit tests for AmzSpApi::VendorDirectFulfillmentOrdersV1::VendorOrdersApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VendorOrdersApi' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentOrdersV1::VendorOrdersApi.new
  end
  ...
  describe 'test an instance of VendorOrdersApi' do
    it 'should create an instance of VendorOrdersApi' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentOrdersV1::VendorOrdersApi)
    end
  end
