...
# Unit tests for AmzSpApi::VendorDirectFulfillmentShippingV1::PackedItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackedItem' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentShippingV1::PackedItem.new
  end
  ...
  describe 'test an instance of PackedItem' do
    it 'should create an instance of PackedItem' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentShippingV1::PackedItem)
    end
  end
