...
# Unit tests for AmzSpApi::VendorDirectFulfillmentShippingV1::ShipmentStatusUpdate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShipmentStatusUpdate' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentShippingV1::ShipmentStatusUpdate.new
  end
  ...
  describe 'test an instance of ShipmentStatusUpdate' do
    it 'should create an instance of ShipmentStatusUpdate' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentShippingV1::ShipmentStatusUpdate)
    end
  end
