...
# Unit tests for AmzSpApi::VendorDirectFulfillmentShippingV1::StatusUpdateDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StatusUpdateDetails' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentShippingV1::StatusUpdateDetails.new
  end
  ...
  describe 'test an instance of StatusUpdateDetails' do
    it 'should create an instance of StatusUpdateDetails' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentShippingV1::StatusUpdateDetails)
    end
  end
