...
# Unit tests for AmzSpApi::VendorDirectFulfillmentShipping_20211228::VendorShippingLabelsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VendorShippingLabelsApi' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorDirectFulfillmentShipping_20211228::VendorShippingLabelsApi.new
  end
  ...
  describe 'test an instance of VendorShippingLabelsApi' do
    it 'should create an instance of VendorShippingLabelsApi' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorDirectFulfillmentShipping_20211228::VendorShippingLabelsApi)
    end
  end
