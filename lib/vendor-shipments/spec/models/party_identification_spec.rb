...
# Unit tests for AmzSpApi::VendorShipments::PartyIdentification
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PartyIdentification' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipments::PartyIdentification.new
  end
  ...
  describe 'test an instance of PartyIdentification' do
    it 'should create an instance of PartyIdentification' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipments::PartyIdentification)
    end
  end
