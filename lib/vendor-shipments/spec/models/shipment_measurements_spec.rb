...
# Unit tests for AmzSpApi::VendorShipments::ShipmentMeasurements
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShipmentMeasurements' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipments::ShipmentMeasurements.new
  end
  ...
  describe 'test an instance of ShipmentMeasurements' do
    it 'should create an instance of ShipmentMeasurements' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipments::ShipmentMeasurements)
    end
  end
