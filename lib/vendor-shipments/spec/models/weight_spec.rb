...
# Unit tests for AmzSpApi::VendorShipments::Weight
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Weight' do
  before do
    # run before each test
    @instance = AmzSpApi::VendorShipments::Weight.new
  end
  ...
  describe 'test an instance of Weight' do
    it 'should create an instance of Weight' do
      expect(@instance).to be_instance_of(AmzSpApi::VendorShipments::Weight)
    end
  end
